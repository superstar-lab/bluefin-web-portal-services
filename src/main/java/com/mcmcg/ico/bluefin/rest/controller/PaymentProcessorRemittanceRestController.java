...
public class PaymentProcessorRemittanceRestController {
    ...
    public String get(@RequestParam(value = "search", required = true) String search,
        ...
        String json = objectMapper.writerWithView(Views.Summary.class).writeValueAsString(paymentProcessorRemittanceService.getRemittanceSaleRefundVoidTransactions(search, QueryDSLUtil.getPageRequest(page, size, sort), negate));
